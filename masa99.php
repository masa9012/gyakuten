...
class Zoo
{
    ...
    function info_entry_fee($enegori) {
        if($enegori->age <= 5){
            print($enegori->name."さんの入場料金は ".$this->entry_fee["infant"]." 円です。".PHP_EOL);
        }elseif($enegori->age <= 12){
            print($enegori->name."さんの入場料金は ".$this->entry_fee["children"]." 円です。".PHP_EOL);
        }elseif($enegori->age <= 64){
            print($enegori->name."さんの入場料金は ".$this->entry_fee["adult"]." 円です。".PHP_EOL);
        }elseif($enegori->age <= 120){
            print($enegori->name."さんの入場料金は ".$this->entry_fee["senior"]." 円です。".PHP_EOL);
        }
    }
...
$enegori1 = new Enegori("たま", 3);
$enegori2 = new Enegori("ゆたぼん", 10);
$enegori3 = new Enegori("あじー", 32);
$enegori4 = new Enegori("ぎん", 108);

$enegoris = [$enegori1, $enegori2, $enegori3, $enegori4];

foreach($enegoris as $enegori){
    $zoo->info_entry_fee($enegori);
}
